export default {
  ...
  form: {
    ...
    tldSearch: 'Rechercher des extensions', tldAll: 'Toutes les extensions IANA', tldSecondLevel: 'Domaines de second niveau courants', tldSelected: 'sélectionnées', tldSelectedList: 'Extensions sélectionnées', tldLoading: 'Chargement des extensions…', tldNoMatch: 'Aucune extension ne correspond à votre recherche.',
  ...
  results: {
    ...
    noneGenerated: "Aucun nom de domaine n'a été généré. Essayez d'élargir vos parties de nom ou d'assouplir les filtres de génération.",
  ...
  filters: { availableOnly: 'Disponibles uniquement', checkAll: 'Tout vérifier', exportExcel: 'Exporter vers Excel', exportGoogleSheets: 'Google Sheets', googleSheetsCopied: 'Lignes copiées. Collez-les dans la nouvelle feuille Google.', googleSheetsCopyFailed: 'Une feuille Google a été ouverte. Collez les lignes exportées dans la cellule A1.' },
