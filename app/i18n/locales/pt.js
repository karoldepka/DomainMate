export default {
  ...
  form: {
    ...
    tldSearch: 'Pesquisar extensões', tldAll: 'Todas as extensões IANA', tldSecondLevel: 'Domínios comuns de segundo nível', tldSelected: 'selecionadas', tldSelectedList: 'Extensões selecionadas', tldLoading: 'Carregando extensões…', tldNoMatch: 'Nenhuma extensão corresponde à pesquisa.',
