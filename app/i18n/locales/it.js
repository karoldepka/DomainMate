export default {
  ...
  feedback: {
    ...
    hint: 'Dicci cosa funziona o cosa manca, e sbloccheremo il conteggio dei risultati di Google, i suggerimenti AI e la sincronizzazione delle valutazioni su questo dispositivo, senza pagamento.',
